...
function loadAllRole() {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (result) {
            $('#role').bootstrapTable('load',result);
            $('#role').bootstrapTable('hideColumn','id');
        },
        error: function () {
        }
    });
...
function actionFormatter(value, row, index) {
    return[
        '<a href="#" class="btn btn-outline-primary" id="modify" data-toggle="modal" data-target="#modifyRole">编辑</a>',
