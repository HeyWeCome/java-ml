        ...
        success: function (result) {
            ...
            for(var i in result){
                ...
                var agreeAndDisagreeContent =
                    ...
                    "</button>" +
                    "</div>" +
                    "<div id=\""+result[i].id+"disagree\" onclick=\"addDisAgree(this);\" class=\"down\">" +
                    "<button class=\"btnOfNo btn btn-light\" title=\"不赞同\">" +
                    "<svg t=\"1587203855362\" class=\"icon\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"3945\" width=\"20\" height=\"20\"><path d=\"M512.948148 128c51.863704 0 102.115556 10.145185 149.428148 30.151111 45.700741 19.342222 86.755556 47.028148 122.026667 82.299259s62.957037 76.325926 82.299259 122.026667c20.100741 47.407407 30.245926 97.659259 30.245926 149.522963s-10.145185 102.115556-30.151111 149.428148c-19.342222 45.700741-47.028148 86.755556-82.299259 122.026667s-76.325926 62.957037-122.026667 82.299259c-47.407407 20.100741-97.659259 30.245926-149.522963 30.245926-51.863704 0-102.115556-10.145185-149.428148-30.151111-45.700741-19.342222-86.755556-47.028148-122.026667-82.299259s-62.957037-76.325926-82.299259-122.026667c-20.100741-47.407407-30.245926-97.659259-30.245926-149.522963s10.145185-102.115556 30.151111-149.428148c19.342222-45.700741 47.028148-86.755556 82.29926-122.026667s76.325926-62.957037 122.026666-82.299259c47.407407-20.100741 97.659259-30.245926 149.522963-30.245926m0-42.666667C277.333333 85.333333 86.281481 276.385185 86.281481 512s191.051852 426.666667 426.666667 426.666667 426.666667-191.051852 426.666667-426.666667S748.562963 85.333333 512.948148 85.333333z\" p-id=\"3946\" fill=\"#FFA800\"></path><path d=\"M611.84 721.161481c-11.757037 0-21.333333-9.576296-21.333333-21.333333 0-42.192593-34.322963-76.420741-76.420741-76.420741s-76.420741 34.322963-76.420741 76.420741c0 11.757037-9.576296 21.333333-21.333333 21.333333s-21.333333-9.576296-21.333333-21.333333c0-65.706667 53.475556-119.087407 119.087407-119.087407s119.087407 53.475556 119.087407 119.087407c0 11.851852-9.576296 21.333333-21.333333 21.333333zM308.622222 376.414815c-19.626667 0-35.555556 15.928889-35.555555 35.555555s15.928889 35.555556 35.555555 35.555556 35.555556-15.928889 35.555556-35.555556-15.928889-35.555556-35.555556-35.555555zM720.118519 376.414815c-19.626667 0-35.555556 15.928889-35.555556 35.555555s15.928889 35.555556 35.555556 35.555556 35.555556-15.928889 35.555555-35.555556-15.928889-35.555556-35.555555-35.555555z\" p-id=\"3947\" fill=\"#FFA800\"></path></svg>" +
                ...
                var discuss = head+agreeAndDisagreeContent+tail;
...
// 点击踩
function addDisAgree(subject) {
    // alert(subject.children(".count").html());
    var id = subject.id;
    var count = parseInt($("#"+id).find("span").html()) +1;
    $("#"+id).find("span").html(count);

    // 修改数据库，1：添加用户和踩的关联，2：修改回答的赞
    console.log(count);
}
